...
namespace MLAgents
{
    ...
    public struct AgentInfo {
        ...
        public CommunicatorObjects.AgentInfoProto
        ToProto()
        {
    ...
    public abstract class Agent : MonoBehaviour
    {
        ...
        /// facilitate testing.
        void
        OnEnableHelper(Academy academy)
        {
            info   = new AgentInfo();
        ...
        protected void
        SetActionMask(IEnumerable<int> actionIndices)
        {
        ...
        protected void
        SetActionMask(int branch, int actionIndex)
        {
        ...
        protected void
        SetActionMask(int branch, IEnumerable<int> actionIndices)
        {
        ...
        protected void
        AddVectorObs(float observation)
        {
        ...
        /// <param name="observation">Observation.</param>
        protected void
        AddVectorObs(Vector3 observation)
        {
        ...
        /// <param name="observation">Observation.</param>
        protected void
        AddVectorObs(Vector2 observation)
        {
            info.vectorObservation.Add(observation.x);
            info.vectorObservation.Add(observation.y);
        }
        ...
        /// <param name="observation">Observation.</param>
        protected void
        AddVectorObs(IEnumerable<float> observation)
        {
        ...
        /// <param name="observation">Observation.</param>
        protected void
        AddVectorObs(Quaternion observation)
        {
            info.vectorObservation.Add(observation.x);
            info.vectorObservation.Add(observation.y);
            info.vectorObservation.Add(observation.z);
        ...
        protected void
        AddVectorObs(bool observation)
        {
            info.vectorObservation.Add(observation ? 1f : 0f);
        }

        protected void
        AddVectorObs(int observation, int range)
        {
        ...
        public void
        SetTextObs(string textObservation)
        {
        ...
        /// </param>
        public virtual void
        AgentAction(float[] vectorAction, string textAction, CommunicatorObjects.CustomAction customAction)
        {
        ...
        public void
        UpdateVectorAction(float[] vectorActions)
        {
        ...
        public void
        UpdateMemoriesAction(List<float> memories)
        {
            action.memories = memories;
        }

        public void
        AppendMemoriesAction(List<float> memories)
        {
        ...
        public void
        UpdateTextAction(string textActions)
        {
        ...
        public void
        UpdateCustomAction(CommunicatorObjects.CustomAction customAction)
        {
        ...
        /// <returns></returns>
        protected float
        ScaleAction(float rawAction, float min, float max)
        {
        ...
        /// </summary>
        void
        MakeRequests(int academyStepCounter)
        {
        ...
        public static void
        ObservationToTexture(Camera obsCamera, int width, int height, ref Texture2D texture2D)
        {
        ...
        /// <param name="texture2D">Texture2D to render to.</param>
        public static void
        ObservationToTexture(RenderTexture obsTexture, int width, int height, ref Texture2D texture2D)
        {
            if (width != texture2D.width || height != texture2D.height) {
                texture2D.Resize(width, height);
            }
        ...
        public void
        SetCustomObservation(CustomObservation customObservation)
        {
